...
import 'package:frontend/src/features/products/product_detail/product_detail_desktop.dart';
import 'package:frontend/src/features/products/product_detail/product_detail_mobile.dart';
...
class _ProductDetailState extends State<ProductDetail> with GetItStateMixin {
  _setup() async {
    get<StockViewModel>().fetchProduct(context, widget.productId, false);
