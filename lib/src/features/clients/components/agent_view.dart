...
class AgentView extends StatelessWidget with GetItMixin {
  AgentView({super.key});
    ...
    return SizedBox(
      child: Padding(
        ...
        child: ListView.builder(
          itemCount: watchOnly((StockViewModel x) => x.agents).length,
              ...
              child: Card(
                child: InkWell(
                  onTap: () async {
                    ...
                    await get<StockViewModel>().getTableByAgentId(
                      context: context,
                      agentId: item['id'],
                    );
